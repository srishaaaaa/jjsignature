...
// ── Category thumbnails ── no per-category photography yet, so every
// category tile uses the same branded placeholder until real shop photos are supplied.
const CAT_PLACEHOLDER = '/product-placeholder.svg'
const CAT_FALLBACK: [string, string, string] = [CAT_PLACEHOLDER, CAT_PLACEHOLDER, CAT_PLACEHOLDER]
  ...
  return (
    <div className="bg-[#F9FAFB] text-[#111111]">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          >
            ...
            {/* Subtitle */}
            <p className="text-[15px] sm:text-[16px] text-[#374151] leading-[1.7] font-medium mb-2.5 max-w-[420px]">
              {t('hero.subtitle')}
            </p>
          ...
          >
            {/* Main hero visual — placeholder brand panel until real store photos/video are supplied */}
            <div className="relative w-full max-w-[620px] aspect-video rounded-[2rem] overflow-hidden
              ...
              bg-gradient-to-br from-[#141414] via-[#1e1a10] to-[#2a2418]">
              <img src="/logo.png" alt={BRAND_EN} className="w-32 h-32 sm:w-44 sm:h-44 object-contain opacity-95" />
              {/* Subtle bottom vignette for depth */}
              <div className="absolute inset-0 bg-gradient-to-t from-[#111111]/10 via-transparent to-transparent pointer-events-none" />
            </div>

            {/* ─ Floating card: top-right — Craftsmanship badge ─ */}
            <motion.div
              animate={{ y: [0, -7, 0] }}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        <div className="relative rounded-[2rem] overflow-hidden bg-[#111111] text-white
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <h2 className="font-black mb-5 break-words text-[36px] sm:text-5xl lg:text-[58px] leading-[1.05] tracking-tight">
              {t('banner.title')}
            </h2>
            <p className="text-[14px] sm:text-[16px] text-white/65 mb-10 font-medium leading-relaxed max-w-sm">
              {t('banner.sub')}
            </p>
            <Link
              to="/products"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24 text-center">
        <h2 className="font-black mb-8 text-[#111111] break-words text-2xl sm:text-3xl tracking-tight">
          {t('more.title')}
        </h2>
